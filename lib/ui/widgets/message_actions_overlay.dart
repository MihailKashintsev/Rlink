            ...
            Positioned.fill(
              child: GestureDetector(
                ...
                child: ClipPath(
                  ...
                  // Размытие фона под меню — эффект, который живёт лишь пока меню
                  // открыто (над «замороженным» чатом), поэтому на скролл/простой
                  // FPS не влияет и включён всегда (в т.ч. на Android), несмотря
                  // на общий тумблер «жидкого стекла».
